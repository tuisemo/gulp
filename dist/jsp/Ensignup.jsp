...
<body data-type="enterprise">
                ...
                <form class="form-horizontal col-sm-12 col-xs-12" action="/dis/passport/reg" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-5">
                            <div class="checkbox">
                                <label>
                                    <input id="check" type="checkbox" checked="checked"><small>我已阅读并接受 <a href="http://www.ixm.gov.cn/sy/fwxy/index.html" target="_blank">“法人通行证”服务协议</a></small>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-5">
                            <div class="btn btn-primary col-sm-12 col-xs-12" onclick="EnPassport.EnterpriseSignUp()">提交注册</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-5">
    ...
    <script>
    require(['DES4', '脚本tools', '脚本EnPassport'], function() {});
    </script>
</body>
